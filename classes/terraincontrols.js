...
export class TerrainLayerToolBar extends Application {
  ...
  static get defaultOptions() {
    const options = {
      ...
      left: 98,
      popOut: false,
      template: "modules/simple-terrain/templates/terrain-controls.html",
  ...
  getData(options) {
    ...
    let multiple =
      sceneMult === undefined || sceneMult === ""
        ? canvas.terrain.defaultmultiple
    ...
    return {
      ...
      disabled: disabled,
      title: disabled ? i18n("SimpleTerrain.DefaultCost") : i18n("SimpleTerrain.Cost")
    };
  }
